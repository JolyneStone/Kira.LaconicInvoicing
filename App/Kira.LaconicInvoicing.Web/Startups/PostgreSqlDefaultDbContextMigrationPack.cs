...
namespace Kira.LaconicInvoicing.Web.Startups
{
    ...
    public class PostgreSqlDefaultDbContextMigrationPack : MigrationPackBase<BusinessDbContext>
    {
        /// <summary> 
        ...
        /// <returns></returns>
        protected override BusinessDbContext CreateDbContext(IServiceProvider scopedProvider)
        {
